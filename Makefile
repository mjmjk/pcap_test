...
# Template: app
# Command: /home/kmj/Qt/5.13.0/gcc_64/bin/qmake -o Makefile ../Downloads/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../Downloads -I. -I../Qt/5.13.0/gcc_64/mkspecs/linux-g++
QMAKE         = /home/kmj/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/kmj/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/kmj/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DISTDIR = /home/kmj/build-pcap_test-Desktop_Qt_5_13_0_GCC_64bit-Debug/.tmp/pcap_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
Makefile: ../Downloads/pcap_test.pro ../Qt/5.13.0/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.13.0/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/gcc-base.conf \
